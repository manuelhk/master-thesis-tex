...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{conv_operation.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{pool_operation.pdf}
...
\subfloat[many to many]{\includegraphics[scale=0.7]{rnn_1.pdf}} &
\subfloat[many to one]{\includegraphics[scale=0.7]{rnn_2.pdf}} \\
\end{tabular}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{single_frame_classification.pdf}
...
\subfloat[Frühe Fusion]{\includegraphics[scale=0.6]{fusion_early.pdf}} &
\subfloat[Späte Fusion]{\includegraphics[scale=0.6]{fusion_late.pdf}} &
\subfloat[Langsame Fusion]{\includegraphics[scale=0.6]{fusion_slow.pdf}} 
\end{tabular}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{cnn_lstm_architektur.pdf}
