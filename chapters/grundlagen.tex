...
\begin{figure}[h]
\centering
\begin{tabular}{c@{\hskip 1.5cm}c@{\hskip 1.5cm}c}
\subfloat[Frühe Fusion]{\includegraphics[scale=0.5]{fusion_early.pdf}} &
\subfloat[Späte Fusion]{\includegraphics[scale=0.5]{fusion_late.pdf}} &
\subfloat[Langsame Fusion]{\includegraphics[scale=0.5]{fusion_slow.pdf}} 
\end{tabular}
