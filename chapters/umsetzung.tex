...
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{cm_road_bild.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{xception.png}
...
Early Stopping ist eine Methode bei der das Training eines \acp{KNN} abgebrochen wird, wenn die Genauigkeit oder oder Fehler sich nicht weiter verbessern \cite{prechelt1998early}. In dieser Arbeit wird die Validierungs-Genauigkeit (engl. validation accuracy) als Metrik verwendet und das Training wird beendet, wenn sich diese Metrik innerhalb von 15 Epochen nicht mindestens um den Wert 0,01 verbessert.
